...
public class GuiSetMusic extends GuiScreen
{
	...
	public GuiSetMusic(GuiScreen gui)
	{
	...
	public void initGui()
	{
		...
		GuiButton label = new GuiButton(4, leftAlign, 10, leftWidth, 20, I18n.format("gui.musiclist"));
	...
	public void drawScreen(int p_571_1_, int p_571_2_, float p_571_3_)
	{
		...
		this.drawString(fontRendererObj, I18n.format("music") + ":", rightAlign, height / 2 - 50, 0xFFFFFF);
		if(selectedSound != null)
