package com.zoonie.customguisounds.input;
...
import com.zoonie.customguisounds.gui.GuiSetSound;
...
public class InputHandler
{
	...
	public void onGuiOpenEvent(GuiOpenEvent event)
	{
		...
		else if(lastGui != null)
		{
			...
			if(sound != null && !GuiSetSound.open)
			{
				MovingObjectPosition mop = mc.objectMouseOver;
				BlockPos pos = mc.theWorld != null ? mop.getBlockPos() : new BlockPos(0, 0, 0);
	...
	{
		if(Keyboard.isKeyDown(Keyboard.KEY_RCONTROL) && !GuiSetSound.open && event.gui != null)
		{
			mc.displayGuiScreen(new GuiSetSound(mc.currentScreen));
		}
	}
}
